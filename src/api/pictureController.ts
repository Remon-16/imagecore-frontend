...
/** 此处后端没有提供注释 POST /picture/text_gen/create_task */
export async function createPictureByText(
  body: API.Text2ImageTaskRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseText2ImageTaskResponse>('/picture/text_gen/create_task', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 GET /picture/text_gen/get_task */
export async function getText2ImageTask(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getText2ImageTaskParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseGeText2ImageTaskResponse>('/picture/text_gen/get_task', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function uploadPicture(
  ...
  return request<API.BaseResponseBoolean>('/picture/upload', {
    method: 'POST',
    params: {
      ...params,
    },
