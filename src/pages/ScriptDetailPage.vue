...
/* 调整AIGenImage组件外部样式 */
.ai-gen-image-wrapper ::v-deep(.ant-btn) {
...
.ai-gen-image-wrapper ::v-deep(.ant-btn):hover {
  background-color: #189fff;
  border-color: #189fff;
  color: #fff;
}

.ai-gen-image-wrapper ::v-deep(.ant-btn):active {
